...
# ADD LINK32 glu32.lib glut32.lib opengl32.lib libARvideo.lib libAR.lib libARgsub.lib libARMulti.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib:"msvcrtd.lib" /nodefaultlib:"msvcrt.lib" /nodefaultlib:"LIBCMT.lib" /out:"../../bin/multiTest.exe" /pdbtype:sept /libpath:"../../lib"
